...
import { saveShippingAddressMapLocation, setFullBoxOn } from "../features/cartSlice";
...
const Map = () => {
    ...
    useEffect(() => {
        const fetch = async () => {
            const { data } = await axios.get("/api/v1/keys/google", {
    ...
    const onConfirm = () => { 
        ...
        dispatch(
            saveShippingAddressMapLocation({
                ...
                googleAddressId: places[0].vicinity,
            })
        );
